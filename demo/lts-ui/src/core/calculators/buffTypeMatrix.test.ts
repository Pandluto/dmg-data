...
const ZONE_CONTEXT_EXPECTATIONS = [
  ...
  },
  {
    ...
    skillType: 'A' as const,
    types: [
      'magicDmgBonus', 'allElementDmgBonus', 'fireDmgBonus', 'fireNatureDmgBonus', 'allDmgBonus', 'normalAttackDmgBonus',
  ...
  },
  {
    ...
    types: [
      'magicDmgBonus', 'allElementDmgBonus', 'electricDmgBonus', 'iceElectricDmgBonus', 'allDmgBonus',
  ...
  },
  {
    ...
    types: [
      'magicDmgBonus', 'allElementDmgBonus', 'iceDmgBonus', 'iceElectricDmgBonus', 'allDmgBonus',
  ...
  },
  {
    ...
    types: [
      'magicDmgBonus', 'allElementDmgBonus', 'natureDmgBonus', 'fireNatureDmgBonus', 'allDmgBonus',
  ...
  },
  {
    ...
    types: [
      'magicDmgBonus', 'allElementDmgBonus', 'fireDmgBonus', 'fireNatureDmgBonus', 'allDmgBonus', 'dotDmgBonus',
      'magicFragile', 'fireFragile', 'magicVulnerability', 'fireVulnerability',
      'magicAmplify', 'fireAmplify', 'multiplierBonus',
    ],
  },
