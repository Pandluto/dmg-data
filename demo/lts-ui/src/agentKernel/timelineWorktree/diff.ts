...
function normalizeButton(button: TimelineSnapshotPayload['skillButtonTable'][string]): TimelineButtonDiffItem {
  const item: TimelineButtonDiffItem = {
    ...
    basicAttackTailBundleId: button.basicAttackTailBundle?.id,
    basicAttackTailPeerId: button.basicAttackTailBundle
      ? button.basicAttackTailBundle.predecessorButtonId === button.id
...
function compareButton(before: TimelineButtonDiffItem, after: TimelineButtonDiffItem): TimelineButtonChange | null {
  ...
  compareField(changes, 'basicAttackStageCount', before.basicAttackStageCount, after.basicAttackStageCount);
  compareField(changes, 'basicAttackTailBundleId', before.basicAttackTailBundleId, after.basicAttackTailBundleId);
  compareField(changes, 'basicAttackTailPeerId', before.basicAttackTailPeerId, after.basicAttackTailPeerId);
  compareField(changes, 'releaseAnchor', before.releaseAnchor, after.releaseAnchor);
