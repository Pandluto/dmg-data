...
function App() {
  ...
  if (isOverlayPath(currentPath)) {
    ...
    else if (currentPath === APP_ROUTE_PATHS.resourcePackager) overlay = <DataWorkspacePage />;
    else overlay = <StartPage />;
  } else if ([APP_ROUTE_PATHS.draft, APP_ROUTE_PATHS.buffSheet, APP_ROUTE_PATHS.weaponSheet,
    APP_ROUTE_PATHS.equipmentSheet, APP_ROUTE_PATHS.imageManager].some(path => path === currentPath)) {
